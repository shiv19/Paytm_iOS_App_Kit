#
#  Be sure to run `pod spec lint paytmPayment.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Nikhil Agarwal" => "nikhil.agarwal@paytm.com" }
  # Or just: s.author    = "Nikhil Agarwal"
  # s.authors            = { "Nikhil Agarwal" => "nikhil.agarwal@paytm.com" }
  # s.social_media_url   = "http://twitter.com/Nikhil Agarwal"
  ...
  s.ios.library = 'Paytm/libPaymentsSDK'
